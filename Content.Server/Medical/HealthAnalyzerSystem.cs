...
public sealed partial class HealthAnalyzerSystem : EntitySystem
{
    ...
    public void BeginAnalyzingEntity(Entity<HealthAnalyzerComponent> healthAnalyzer, EntityUid target, // SIS-Cortical_Borer | private
    ...
    public void StopAnalyzingEntity(Entity<HealthAnalyzerComponent> healthAnalyzer, EntityUid target) // SIS-Cortical_Borer
    {
        //Unlink the analyzer
        ...
        EntityUid? part) // Trauma
    {
        ...
        return new HealthAnalyzerUiState(
            ...
            unrevivable,
            _wound.GetWoundableStatesOnBody(entity),

...
namespace Content.Server.RoundEnd
{
    ...
    public sealed partial class RoundEndSystem : EntitySystem
    {
            ...
            string callerName = "", string reason = "") // Trauma
        {
            ...
            _audio.PlayGlobal("/Audio/_SIS/Announcements/shuttlecalled.ogg", Filter.Broadcast(), true); // SIS
            ...
            // <Trauma>
        {
            ...
            _audio.PlayGlobal("/Audio/_SIS/Announcements/shuttlerecalled.ogg", Filter.Broadcast(), true); // SIS

...
namespace Content.Server.GameTicking
{
    public sealed partial class GameTicker
    {
        ...
        /// </summary>
        public void JoinAsObserver(ICommonSession player, bool isAdminGhost = false) // SIS-Lobby_AGhost
        {
            // Can't spawn players with a dummy ticker!
            if (DummyTicker)
                return;
            ...
            SpawnObserver(player, isAdminGhost); // SIS-Lobby_AGhost
        }
        ...
        /// </summary>
        public void SpawnObserver(ICommonSession player, bool isAdminGhost = false) // SIS-Lobby_AGhost
        {
            if (DummyTicker)
                return;
            ...
            var ghost = _ghost.SpawnGhost(mind.Value, isAdminGhost: isAdminGhost); // SIS-Lobby_AGhost
            if (makeObserver)

...
shell-can-only-run-from-pre-round-lobby = Вы можете выполнить эту команду только пока игра находится в предраундовом лобби.
shell-can-only-run-while-round-is-active = Вы можете выполнить эту команду только пока идёт раунд.
...
shell-argument-chat-invalid = Аргумент {$index} должен быть допустимым чатом!

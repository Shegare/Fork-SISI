inspect-wound-minor = травмировано
inspect-wound-moderate = повреждено
inspect-wound-severe = сильно повреждено
inspect-wound-critical = раздроблено
...
inspect-wound-weeping-avulsion-severe = полностью разорвано, со значительной потерей тканей

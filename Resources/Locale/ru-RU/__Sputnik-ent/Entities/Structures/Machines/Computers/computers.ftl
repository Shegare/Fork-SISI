...
ent-ComputerSurveillanceWirelessXenoborgCameraMonitor = монитор камер ксеноборга
    .desc = Монитор беспроводных камер ксеноборга. Вы наблюдаете за ними. Возможно.
...
ent-StationAiFixerComputer = консоль восстановления ИИ
    .desc = Используется для восстановления повреждённых искусственных интеллектов.

ent-ComputerNukieDelivery = компьютер доставки Синдиката
    .desc =
        Компьютер, способный доставить из блюспейса определённое снаряжение для Ядерных Операций.

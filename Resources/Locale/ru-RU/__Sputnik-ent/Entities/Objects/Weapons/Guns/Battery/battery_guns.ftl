...
ent-WeaponLaserCarbine = лазерный пистолет
    .desc = Излюбленное оружие службы безопасности «NanoTrasen» за дешевизну и простоту использования.
...
ent-WeaponPulseCarbine = импульсный карабин
    .desc = Передовой импульсный карабин, обычно используемый ополчением «NanoTrasen».

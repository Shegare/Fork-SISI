...
ent-BorgModuleFireExtinguisher = реактивный модуль киборга
    .desc = NT поручила команде разработать реактивный ранец для юнитов-киборгов, но у них закончилось финансирование, и они просто сделали огнетушитель побольше. Впрочем, он оснащён встроенным GPS и сканером массы!

ent-ChameleonProjectorNoBattery = проектор-хамелеон
    .desc = Технология голопаразитов, используемая для создания световой реплики любого окружающего предмета. Маскировка разрушается при поднятии или отключении.

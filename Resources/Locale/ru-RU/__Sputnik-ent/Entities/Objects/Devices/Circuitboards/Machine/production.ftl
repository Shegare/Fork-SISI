...
ent-SurveillanceCameraWirelessRouterXenoborgCircuitboard = маршрутизатор беспроводных камер ксеноборга (машинная плата)
    .desc = Печатная плата маршрутизатора беспроводных камер ксеноборга.

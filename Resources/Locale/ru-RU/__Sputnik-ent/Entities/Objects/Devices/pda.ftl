...
ent-MedicalInternPDA = КПК медицинского интерна
...
ent-QuartermasterPDA = КПК квартирмейстера
    .desc = КПК для того парня, что заказывает оружие.

ent-CargoPDA = КПК грузчика
    .desc = КПК для тех парней, что заказывают пиццу.
...
ent-LawyerPDA = КПК юриста
    .desc = Для юристов, охотящихся за сомнительными клиентами.
...
ent-HoPPDA = КПК главы персонала
    .desc = Выглядит так, будто его жевали.

ent-CEPDA = КПК старшего инженера
    .desc = Выглядит почти неиспользованным.
...
ent-AdminPDA = КПК админа
    .desc = Если вы не админ, пожалуйста, верните этот КПК ближайшему админу.
    .suffix = Админ

ent-MusicianPDA = КПК музыканта
    .desc = Наполняет вас вдохновением.
...
ent-SyndiPDA = КПК синдиката
    .desc = Ладно, время быть продуктивным членом... о, круто, я плохой парень, пора убивать людей!
...
ent-SyndiCommanderPDA = КПК командира синдиката
    .desc = Так кто мы, что-то вроде отряда нюкеров?
...
ent-TramDriverPDA = КПК водителя трамвая
    .desc = Серьёзный водитель всегда прибывает вовремя.
...
ent-BrigmedicPDA = КПК бригмедика
    .desc = Интересно, чей пульс на экране? Надеюсь, он не остановится...
...
ent-SeniorCourierPDA = КПК ведущего курьера
    .desc = Пахнет почтовыми марками и шаттл-топливом.

...
ent-GlovesBoxingRiggedRandomSpawner = случайный спавнер подстроенных боксёрских перчаток
    .desc = { "" }
...
ent-ClothingHandsKnuckleDustersStun = оглушающий кастет
    .desc = Кастет, совмещённый с технологией electро-дубинки. Это значительно облегчает избиение тайдеров.
...
ent-ActionHereticVoidConduitAscension = Проводник Пустоты
...
ent-ActionHereticVoidConduit = { ent-ActionHereticVoidConduitAscension }
    .desc = Открывает врата в Пустоту. Они периодически испускают импульс, повреждающий окна и шлюзы, а также насылающий на неверных холод Пустоты. Затронутые же еретики получают сопротивление низкому давлению. Имеет 1 заряд, который можно восполнить, сломав (использовав) клинок в руке.
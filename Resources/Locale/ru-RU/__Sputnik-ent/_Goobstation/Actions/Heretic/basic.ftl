...
ent-DisguiseRevertAction = Вернуть облик
    .desc = Возвращает вас в изначальный облик.

ent-ActionToggleAbyssalMask = Переключить Бездонную Маску
    .desc = Переключает между режимом ночного видения и режимом защиты от страха/глаз
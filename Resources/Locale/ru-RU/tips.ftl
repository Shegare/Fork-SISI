...
tips-dataset-38 = Будучи предателем, форон в газообразном виде — отличный способ навести хаос. Его можно поджечь, чтобы сделать область непригодной для жизни, а также он может наносить токсический урон тем, кто его вдыхает.
tips-dataset-39 = Будучи предателем, обезвоженные карпы полезны для убийства большого количества людей.
tips-dataset-40 = Будучи предателем, вы пробовали вводить форон в батареи? В случае с дефибриллятором он взрывается при использовании, нанося вред и пользователю, и пациенту!
...
tips-dataset-74 = Будучи инженером, вы можете использовать форон-стекло для укрепления местности и защиты от радиации. Урановое стекло также можно использовать для защиты от радиации.
...
# AUTOGEN-Start
# Пожарные костюмы и зимние куртки обеспечивают умеренную защиту от холода, позволяя вам проводить в космосе и в разгерметизированных отсеках больше времени, чем если бы на вас не было ничего.
# AUTOGEN-End TODO(Update_Locale):
tips-dataset-94 = Пожарные костюмы, зимние куртки и аварийные гермокостюмы обеспечивают умеренную защиту от холода, позволяя проводить больше времени возле пробоин и в космосе, чем без одежды.
# AUTOGEN-Start
# В экстренной ситуации не забывайте, что пожарные и экстренные EVA скафандры всегда находятся в соответствующих шкафчиках. В них может быть неудобно передвигаться, но они могут легко спасти вам жизнь в плохой ситуации!
# AUTOGEN-End TODO(Update_Locale):
tips-dataset-95 = В экстренной ситуации всегда можно положиться на пожарные костюмы и аварийные гермокостюмы: они всегда появляются в соответствующих шкафчиках. В них может быть неудобно двигаться, но они легко спасут вам жизнь в опасной ситуации.
...
tips-dataset-98 = Вы можете создавать копья из осколков армированного стекла, форон-стекла или уранового стекла для увеличения их урона.
...
tips-dataset-140 = В лотерейных ящиках с очень малой вероятностью может оказаться Тронглер.

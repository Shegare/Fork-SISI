...
humanoid-profile-editor-randomize-unlocked-button = Рандомизировать незаблокированное
...
humanoid-profile-editor-randomizer-lock-tooltip = Не позволяет значению быть рандомизированным

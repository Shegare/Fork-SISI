...
law-ntdefault-name = Стандартные законы НТ
...
laws-ui-menu-title = Законы синтетика
laws-ui-law-header = Закон { $id }
laws-ui-select-all = Выбрать все
laws-ui-select-all-tooltip = Будут выбраны ВСЕ законы, включая те, которые, вероятно, должны оставаться в секрете.
laws-ui-select-none = Снять выбор
laws-ui-state-law = Объявить выбранные законы
...
laws-window-footer-left = Помните: ваша трактовка законов должна быть последовательной!

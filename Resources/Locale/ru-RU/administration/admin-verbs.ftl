...
admin-verbs-admin-logs-player = Логи игроков
...
admin-verbs-refill-internals-oxygen = Пополнить внутр. запас кислорода
admin-verbs-refill-internals-nitrogen = Пополнить внутр. запас азота
admin-verbs-refill-internals-plasma = Пополнить внутр. запас плазмы
admin-verbs-send-to-test-arena = Отправить на тестовую арену
admin-verbs-grant-all-access = Выдать полный доступ
admin-verbs-revoke-all-access = Отозвать весь доступ
...
admin-verbs-bar-job-slots = Заблокировать слоты должности
...
admin-verbs-snap-joints = Зафиксировать соединения
admin-verbs-make-minigun = Сделать миниганом
admin-verbs-set-bullet-amount = Задать количество патронов

# Toggles verbs
admin-verbs-bolt = Заблокировать (болт)
admin-verbs-unbolt = Разблокировать (болт)
admin-verbs-emergency-access-on = Аварийный доступ вкл.
admin-verbs-emergency-access-off = Аварийный доступ выкл.
...
admin-verbs-dialog-set-bullet-amount-title = Задать количество патронов

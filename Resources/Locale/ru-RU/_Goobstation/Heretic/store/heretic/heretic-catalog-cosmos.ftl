knowledge-path-cosmos-passive-desc-1 = Космические поля ускоряют вас и восстанавливают выносливость.
knowledge-path-cosmos-passive-desc-2 = Космические поля теперь блокируют взрывы, нарушают работу гранат или сигналов и отключают уже активированные гранаты.
knowledge-path-cosmos-passive-desc-3 = Космические поля теперь замедляют снаряды.
...
knowledge-path-cosmos-armor-name = звёздотканый плащ
# AUTOGEN-Start
...
# Позволяет превратить стол (или костюм), маску и лист форона в Звёздотканый плащ,
# который защищает от опасностей космоса и позволяет свободно передвигаться в невесомости.

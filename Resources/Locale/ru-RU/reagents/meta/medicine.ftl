...
reagent-desc-diphenhydramine = Быстро очищает организм от гистамина, снижает нервозность и дрожь, вызывает сонливость и лечит повреждения ядами. Часто входит в состав снотворных препаратов.
...
reagent-desc-phalanximine = Современный препарат, используемый при лечении рака. Вызывает умеренное лучевое поражение, кислотные ожоги и рвоту у органиков. Потенциально может удалить ген смерти у растений.
...
reagent-desc-ambuzol-plus = Усовершенствован с помощью омнизина, прививает живых против инфекции.
...
reagent-desc-puncturase = Шипучее химическое вещество, залечивающее колотые ранения, но оставляющее небольшое повреждение тканей.
...
reagent-desc-arcryox = Отвратительно-синий криогенный химикат, способный залечивать тяжёлые раны даже у мёртвых. Однако ему сложно стабилизировать пациентов.

reagent-name-aloxadone = алоксадон
reagent-desc-aloxadone = Криогенное химическое вещество. Используется для лечения тяжёлых ожогов и обморожений путём регенерации поражённых тканей. Работает независимо от того, жив пациент или мёртв.
...
reagent-desc-heparin = Часто используется в качестве антикоагулянта. Из-за него кровь с трудом образует сгустки. При передозировке может вызвать внутреннее кровотечение.

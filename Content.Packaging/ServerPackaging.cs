...
public static class ServerPackaging
{
        ...
        CancellationToken cancel)
    {
        ...
        var deps = DepsHandler.Load(Path.Combine(sourcePath, "Content.SIS.Server.deps.json")); // inky edit - fix client crash? // SIS
    ...
    {
        var depsContent = deps.RecursiveGetLibrariesFrom($"Content.SIS.{side}").SelectMany(GetLibraryNames); // inky edit - fix client crash? // SIS
